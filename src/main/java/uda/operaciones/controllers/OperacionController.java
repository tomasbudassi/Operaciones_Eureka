...
public class OperacionController {
	...
	public String sumar(@RequestParam float a, @RequestParam float b) {
		...
		return clienteRest.getForObject("https://resultados-usa-tbudassi.herokuapp.com/resultado/" + resultado , String.class);
	}
	...
	public String sumarEuropa(@RequestParam float a, @RequestParam float b) {
		String resultado = Float.toString(a + b);
		return clienteRest.getForObject("https://resultados-europa-tbudassi.herokuapp.com/resultado/" + resultado , String.class);
	}
